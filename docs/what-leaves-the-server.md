...
scheduled task:
    ...
    origin/master:Jellyfin.Plugin.Template/Refresh/DiscoverRefreshTask.cs:381:                new CatalogueDocumentStore(new CatalogueDirectory(dataFolderPath), _storeLogger),
    exit=0
