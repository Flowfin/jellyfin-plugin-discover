...
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | --------------- |
| Pressing play on a title the server does not have is not a supported action in any client, and no form of the answer makes it one. What the server sends is a successful answer describing one source that cannot be played, rather than a refusal a client could draw as a message, so each client does something different with it and none of the differences is this plugin's to choose. The decided answer is a short clip explaining how to ask for the title, and nothing in the package is a clip. | [#56](https://github.com/Flowfin/jellyfin-plugin-discover/issues/56)                                                                   | Read            |
| A shelf standing empty and a shelf that no longer exists are two different answers inside this plugin and one answer to a client. The server answers a level out of the library rather than out of what a channel returned, so the total the two differ in never leaves this plugin.                                                                                                                                                                                                                       | [#54](https://github.com/Flowfin/jellyfin-plugin-discover/issues/54)                                                                   | Read            |
