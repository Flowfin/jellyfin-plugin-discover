...
Eight jobs here declare that they follow another:
    ...
    .github/workflows/publish.yaml:302:    needs: gate
    .github/workflows/publish.yaml:446:    needs: build
    .github/workflows/publish.yaml:472:    needs: [build, attest]
    .github/workflows/publish.yaml:565:    needs: [gate, build, attest, release]
